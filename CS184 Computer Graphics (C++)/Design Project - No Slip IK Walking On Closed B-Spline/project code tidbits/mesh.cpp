...
{
	//clear();
	faces.clear(); verts.clear();   //CHECKTHISIFBUGGY //and look above. we are not clearing edges?
	...
	while (getline(f,line)) {
		...
		{
            //faces.push_back(Face());
			//Face &f = faces.back();  //CHECKTHISIFBUGGY //faces?
			vector<int> first, second;
			vector<int> orig;
			Face f;		
